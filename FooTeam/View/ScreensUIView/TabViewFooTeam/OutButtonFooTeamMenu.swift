...
struct OutButtonFooTeamMenu: View {
    ...
    var body: some View {
        ...
        .alert(isPresented: self.$isPresentedAlertSignOut) {
            Alert(title: Text(
                NSLocalizedString("OutButtonFooTeamMenuAttention",
                                  comment: "Attention")
            ),
            message: Text(
                NSLocalizedString("OutButtonFooTeamMenuExitApp",
                                  comment: "Do you want to exit the app?")
            ),
            primaryButton: Alert.Button.default(Text(
                NSLocalizedString("OutButtonFooTeamMenuCancel",
                                  comment: "Cancel")
            )),
            secondaryButton: Alert.Button.destructive(
                Text(
                    NSLocalizedString("OutButtonFooTeamMenuGoOut",
                                      comment: "Go out")
                ), action: {
                    do {
