...
struct RowCalendarforInfo: View {
    ...
    var body: some View {
        ZStack {
            VStack {
                HStack {
                    CellCalendarforInfo(dayOfweak: NSLocalizedString("RowCalendarforInfoMonday", comment: "Mo"),
                    ...
                    CellCalendarforInfo(dayOfweak: NSLocalizedString("RowCalendarforInfoTuesday", comment: "Tu"),
                    ...
                    CellCalendarforInfo(dayOfweak: NSLocalizedString("RowCalendarforInfoWednesday", comment: "We"),
                    ...
                    CellCalendarforInfo(dayOfweak: NSLocalizedString("RowCalendarforInfoThursday", comment: "Th"),
                ...
                HStack {
                    ...
                    CellCalendarforInfo(dayOfweak: NSLocalizedString("RowCalendarforInfoFriday", comment: "Fr"),
                    ...
                    CellCalendarforInfo(dayOfweak: NSLocalizedString("RowCalendarforInfoSaturday", comment: "Sa"),
                    ...
                    CellCalendarforInfo(dayOfweak: NSLocalizedString("RowCalendarforInfoSunday", comment: "Su"),
